...
from .views import OrderView, OrderList, Add_To_Order, Get_Customer_Order, OrderItemsList, Get_Vendor_Orders, Add_To_Cart, ViewCartItems
...
urlpatterns = [
    ...
    path('cart', ViewCartItems.as_view())
